...
# inn_data_test <- inn_data
# inn_data_test <- inn_data_test[complete.cases(inn_data_test),]
...
con_var <- c(grep(names(inn_data),pattern="P2",fixed=T),
             grep(names(inn_data),pattern="P3",fixed=T),
             grep(names(inn_data),pattern="P4",fixed=T))
